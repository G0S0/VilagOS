...
void Level::Init() {
	...
	//m_BackgroundTexture.reset(new VilagOS::Texture2D("assets/textures/background.jpg"));
	//m_Textures.resize(6);
...
void Level::LoadLevel() {
	...
	for (int i = 0; i < 8; i++) {
		...
		m_Floors[i].position = glm::vec3(-14.1f + 5 * i, -8.0f, -0.2f);
